...
function ItemCreate(props) {
  ...
  const onSubmit = async (e) => {
    ...
    let response  = await createNew({
      ...
      duration: duration,
      file_id: 459,
      image_source: "https://firebasestorage.googleapis.com/v0/b/homswag.appspot.com/o/images%2FPuryfing%20Canva.png?alt=media&token=6898e04c-069b-4dea-bd6f-dc18f9be33f2",
      mrp_price: mrpPrice,
      name: name,
      organization_id: 1,
      price: price,
